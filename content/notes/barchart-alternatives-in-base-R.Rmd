...
Last week, Tracey Weissgerber and colleagues extend this tradition, making a
...
Here, I'll provide some minimal code to make plots similar to those Weissgerber
...
It's easy to jitter the points, as Weissgerber _et al_ recommend, by passing the
...
R easily produces many other plots, in addition to those Weissgerber _et al_ for
